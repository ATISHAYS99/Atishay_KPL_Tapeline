...
class TapeDemandCalculator:
    ...
    def read_fabric_recipe(self):
        try :
            ...
            # Merge on FabricId
            self.df_ww = pd.merge(df_weft, df_warp, on='FabricId', how='left')
            self.df_ww = pd.merge(self.df_ww, df_warp_rf, on='FabricId', how='left')
